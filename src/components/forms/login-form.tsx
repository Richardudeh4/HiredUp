    ...
    <div className='flex flex-col gap-6'>
        <Card>
            ...
            <CardContent>
                ...
                <GeneralSubmitButton variant="outline" icon={<Github className='size-6'/>} width='w-full bg-[#6672af]' text='Login With Github'/>
                </form>
                <form action={
                    async () => {
                        "use server";
         ...
         <GeneralSubmitButton variant="outline" icon={<Google className='size-6'/>} width='w-full' text='Login With Google'/>
                </form>
                </div>
            </CardContent>
        </Card>
